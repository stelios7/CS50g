...
function love.load()
    ...
    gFrames = {
        ...
        ['special'] = GenerateQuadsSpecial(gTextures['main'])
    }
    ...
    gSounds = {
        ...
        ['specialchest'] = love.audio.newSource('sounds/specialchest.wav', 'static'),
        ['keypowerup'] = love.audio.newSource('sounds/keypowerup.wav', 'static')
    }
