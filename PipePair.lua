...
function PipePair:init(y)
    ...
    -- *NEW gapModifier is a math.random variable to be added on top of GAP_HEIGHT when setting the Pipe Pair
    gapModifier = math.random(-10,50)
    ...
    self.pipes = {
        ...
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + GAP_HEIGHT + gapModifier) -- *NEW gap range is effectively (80 - 140)
    }
